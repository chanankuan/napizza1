...
function renderOrderList() {
  ...
  cart.forEach(item => {
    const { id, name, price, image, numberOfUnits, pizzaSize, ingredients } = item;
...
const returnToCheckoutBtn = document.getElementById('js-return-to-checkout-btn');
...
function goToCheckout() {
  const requiredFields = document.querySelectorAll('.basket-form input[required]');
